    ...
    <div className="min-h-screen flex flex-col items-center bg-white px-4 py-8 font-sora">
      ...
      <div className="w-full max-w-3xl mb-8">
        <div className="flex justify-between items-center mb-2">
          ...
          <select className="text-sm rounded px-2 py-2 bg-[#F2F2F2]">
      ...
      <div className="w-full max-w-3xl flex justify-end">
        <button className="px-6 py-3 rounded-full text-white text-lg font-semibold bg-gradient-to-r from-[#8F64E1] to-[#1D68BD] hover:opacity-90">
          Ask Question
        </button>
      </div>
    </div>
